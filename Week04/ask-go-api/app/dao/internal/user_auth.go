...
// UserAuthColumns defines and stores column names for table user_auth.
type userAuthColumns struct {
	Id           string //
	UserNo       string // 关联用户ID
	AuthAccount  string // 登录ID
	AuthPassword string // 登录密码
	AuthType     string // 账号类型 wechat、welite、app
	LoginIp      string // 最近登录IP
	LoginTime    string // 最近登录时间
	AuthState    string // 状态 默认100，100正常，90禁用
	CreateTime   string // 创建时间
	ModifyTime   string // 更新时间
}

var (
	// UserAuth is globally public accessible object for table user_auth operations.
	UserAuth = &UserAuthDao{
		M:     g.DB("default").Table("user_auth").Safe(),
		Table: "user_auth",
		Columns: userAuthColumns{
			Id:           "id",
			UserNo:       "user_no",
