...
type userColumns struct {
	...
	UserNo      string // 用户ID
	Nickname    string // 昵称
	UserName    string // 用户名，用户唯一标识
	UserAvatar  string // 头像
	UserSex     string // 用户性别 10 男 20女 30 未知保密
	EncryptCode string // 用户加密标识
	RegFrom     string // 邀请人的唯一标识 invite_code
	RegIp       string // 注册IP
	RegTime     string // 注册时间
	RegType     string // 用户注册类型 10小程序 20微信 30app
	RegOs       string // 用户设备系统 10iOS、20Android、30Windows、40macOS、50其他
	UserLevel   string // 用户登记
	AuthSalt    string // 设置密码加盐值
	Mobile      string // 用户绑定手机号
	MbTime      string // 用户绑定手机号时间
	MbState     string // 手机号绑定 0 默认 100已绑定
